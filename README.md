...
# Bước 11. Phân rã Domain và Thiết kế Kiến trúc Microservices
...
flowchart TB
    ...
    Gateway -->|/auth/*, /users/*, /access/*| IAM_Service
    Gateway -->|/rides/*, /operations/problem-*| Trip_Service
    Gateway -->|/drivers/*, /vehicles/*, /operations/drivers/*| Fleet_Service
    Gateway -->|/payments/*, /transactions/*| Billing_Service
    Gateway -->|/customers/*, /rides/*/rating| Customer_Service
    Gateway -->|/reports/*| Analytics_Service

    %% Synchronous Internal API Calls (gRPC / REST)
    Trip_Service -->|Lấy trạng thái tài xế| Fleet_Service
    Trip_Service -->|Tạo giao dịch thanh toán| Billing_Service

    %% Asynchronous Event-Driven Communication
    subgraph EventBus ["Event Broker (Kafka / RabbitMQ)"]
        Broker((Event Stream))
    end

    Trip_Service -.->|RideCreated, RideCompleted| Broker
    Fleet_Service -.->|DriverStatusChanged| Broker
    Billing_Service -.->|PaymentSuccessful, PaymentFailed| Broker
    Customer_Service -.->|CustomerRegistered, RatingSubmitted| Broker
    ...
    Notification_Service -->|Send Messages| ExtSMS

    %% Styling
    classDef core fill:#ffe4e1,stroke:#d9534f,stroke-width:2px,color:#333;
    classDef support fill:#dff0d8,stroke:#5cb85c,stroke-width:2px,color:#333;
